<template>
    <div>
        ...
        <suv-section></suv-section>
        <sedan-section></sedan-section>
        <pickup-trucks></pickup-trucks>
        <shopby-body></shopby-body>
        <shopby-make></shopby-make>
...
import SuvSection from './SuvSection.vue';
import SedanSection from './SedanSection.vue';
import PickupTrucks from './PickupTrucks.vue';
import ShopbyBody from './ShopByBody.vue';
import ShopbyMake from './ShopByMake.vue';
